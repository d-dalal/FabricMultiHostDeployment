...
fetchChannelBlock() {
    ...
    peer channel fetch 0 ./channel-artifacts/$CHANNEL_NAME.block -o 13.92.46.229:7050 \
...
updateAnchorPeers() {
    setGlobalsForPeer0Org2
    # Replace localhost with your orderer's vm IP address
    peer channel update -o 13.92.46.229:7050 --ordererTLSHostnameOverride orderer.example.com \
